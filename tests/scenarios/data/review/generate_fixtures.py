...
def gen_scenario_51():
    ...
    _write_json(d / "search_state.json", {
    ...
    # Mutation log
    _write_json(d / "mutation_log.json", [
        {
            "child_version": "v2",
            "parent_version": "v1",
...
def gen_scenario_52():
    ...
    _write_json(d / "round_reports" / "round_1.json", {
        "v2": v2_report,
    })
...
def gen_scenario_53():
    ...
    for round_num, (version, accuracy, cost, recall) in rounds_data.items():
        ...
        _write_json(d / "round_reports" / f"round_{round_num}.json", {
            version: report,
        })
    ...
    _write_json(d / "v5_score_report.json", _score_report(
        accuracy=0.888,
        cost=0.00215,
    ...
    _write_prompt("v6", base_prompt.replace(
