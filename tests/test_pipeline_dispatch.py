...
class TestReviewFanoutStatus:
    ...
    def test_multi_slot_raises_not_implemented(self, tmp_path: Path) -> None:
        with pytest.raises(NotImplementedError, match="requires a strategy override"):
            review_fanout_status(_RUN_ID, expected=2, output_dir=tmp_path)
