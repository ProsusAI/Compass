...
DEFAULTS_PATH = Path(__file__).resolve().parent.parent / "compass" / "agents" / "user_input" / "defaults.md"
TAXONOMY_PATH = Path(__file__).resolve().parent.parent / "compass" / "agents" / "user_input" / "taxonomy.md"
