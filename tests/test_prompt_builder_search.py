...
class TestSearchState:
    ...
    def test_default_algorithm_is_sentinel(self) -> None:
        # On the pipeline trunk the sentinel value is "__unset__"; leaf branches
        # set _BRANCH_ALGORITHM to a concrete algorithm name before calling init.
        s = SearchState(**self._valid_state())
        assert s.algorithm == "__unset__"
    ...
    def test_old_state_without_algorithm_loads_with_defaults(self) -> None:
        ...
        # Trunk default is the sentinel; leaf branches set a concrete value.
        assert s.algorithm == "__unset__"
        assert s.algorithm_state == {}
