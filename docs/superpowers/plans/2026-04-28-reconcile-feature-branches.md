...
- [ ] **A6** — Project-dir cache + metrics consolidation + run-specific paths. Verify the two pre-existing test failures don't change.
- [ ] **A7** — Tooling: `query_misrouted_examples`, pagination, MCP cleanup. Verify pagination smoke test.
