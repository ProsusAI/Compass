# compass/eval — Evaluation Engine
...
`compass/eval/batch_eval.py` — `run_batch_eval_impl(run_id, candidates, output_dir)`.
...
`compass/agents/eval_runner.py` — `run_eval(context)`:
