...
from compass.agents.final_report.models import (
    BaselineComparison,
    BaselineResult,
    ChartPaths,
    ConfusionEntry,
...
from compass.eval.models import ConfidenceInterval, RunReport
from compass.mcp._render import render_baselines_md, render_score_report_md
