...
**Role:** Extracts parameters from the pipeline context, loads a run config, wires dependencies, delegates to `compass.eval.controller`, and returns a structured `ScoreReport`.
