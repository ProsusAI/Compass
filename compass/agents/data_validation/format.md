...
This document defines the canonical target schema for routing datasets in Project Compass. It describes the format that the Data Validation Agent produces after ingesting and transforming user-provided data.
