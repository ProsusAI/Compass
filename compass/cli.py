...
def run_init(target: Path) -> None:
    ...
    print(f"Initialized Compass project in {target}")
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser = argparse.ArgumentParser(prog="compass", description="Compass Routing Optimizer")
    ...
    if args.command == "init":
        ...
        from compass.mcp import main as mcp_main
