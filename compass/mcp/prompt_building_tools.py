...
from compass.agents.pipeline.dispatch import clear_build_dispatched, record_build_dispatched
...
async def run_batch_eval(
    ...
    from compass.eval.batch_eval import BatchEvalCandidate, run_batch_eval_impl
...
async def get_child_variants(
    ...
    """
    from compass.agents.review.ops import load_child_variants
...
async def signal_eval_complete(
    ...
    """
    from compass.agents.prompt_builder.search_ops import _load_state, _save_state
