...
This document defines the structure and content of the data quality report produced by the Data Validation agent. It is read by the agent at runtime via the `odysseus://agents/data-validation/output-spec` resource handle.
