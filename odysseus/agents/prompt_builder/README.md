...
| [`search_ops.py`](search_ops.py) | File-backed state operations: `init_search_state`, `get_search_state`, `register_candidate`, `record_eval_result`, `advance_round`, `set_loop_phase`. Persists to `outputs/<run_id>/search/`. |
